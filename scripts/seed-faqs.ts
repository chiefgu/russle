...
const FAQS: Record<string, Entry> = {
  'small-business-website-cost-2026': {
    status: 'published',
    items: [
      { question: 'How much does a small business website cost in the UK?', answer: 'It ranges from a few hundred pounds for a template to several thousand for a custom build. At russle, every build includes the structure and search groundwork as standard, not just the pages. Send us a line and we will scope it and come back with a straight quote.' },
