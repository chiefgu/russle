...
export const INDUSTRIES: Record<string, IndustryPageData> = {
  'food-and-drink': {
    ...
    hero: 'A',
    blocks: ['proof', 'pains', 'build', 'faq', 'cta'],
    pains: [
      {
    ...
    build: [
      { title: 'Online ordering', body: 'Products, variants and collection slots, with payment taken upfront.' },
      {
      ...
      { title: 'Wholesale and trade', body: 'Trade price lists and accounts alongside your retail shop.' },
      {
        title: 'Stock and collection dates',
        body: 'Sell what you have, cap what you can make, and close the dates you are away.',
      },
      { title: 'Found on Google', body: 'Product and location pages structured to rank for what you sell.' },
    ],
    proof: {
      slug: 'bethbakescakes',
  ...
  'hair-and-beauty': {
    ...
    hero: 'B',
    blocks: ['pains', 'build', 'proof', 'faq', 'cta'],
    pains: [
      {
      ...
      {
        title: 'Instagram is doing the heavy lifting',
    ...
    build: [
      ...
      { title: 'Price lists that stay current', body: 'Update services and prices yourself in minutes.' },
      {
  ...
  trades: {
    ...
    hero: 'C',
    blocks: ['stats', 'vignetteShowcase', 'build', 'faq', 'cta'],
    showcase: {
      heading: 'From enquiry to five-star review.',
      sub: 'A trades site should run the job pipeline: photos in, quote out, review earned.',
    },
    stats: [
      { value: '24 hours', label: 'We respond to every enquiry within a day.' },
  ...
  hospitality: {
    ...
    hero: 'A',
    blocks: ['build', 'pains', 'reviews', 'faq', 'cta'],
    pains: [
      {
        title: 'The PDF menu',
  ...
  dentists: {
    ...
    hero: 'B',
    blocks: ['stats', 'pains', 'build', 'faq', 'cta'],
    stats: [
      { value: '24 hours', label: 'We respond to every enquiry within a day.' },
  ...
  'financial-services': {
    ...
    hero: 'A',
    blocks: ['pains', 'build', 'stats', 'faq', 'cta'],
    stats: [
      { value: '24 hours', label: 'We respond to every enquiry within a day.' },
  ...
  solicitors: {
    ...
    hero: 'C',
    blocks: ['pains', 'vignetteShowcase', 'build', 'faq', 'cta'],
    showcase: {
      heading: 'The first step, made safe.',
      sub: 'Case type in, callback booked, confidential from the first click.',
    },
    pains: [
      {
  ...
  fashion: {
    ...
    hero: 'B',
    blocks: ['build', 'reviews', 'pains', 'faq', 'cta'],
    pains: [
      {
