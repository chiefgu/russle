...
summary: "A racing media platform combining live odds, expert previews, and the culture around the sport. Launched in 2025. Built for the modern Australian fan who wants more than a form guide and less than a betting app."
metaDescription: "A racing media platform combining live odds, expert previews and the culture around the sport, built for the modern Australian fan."
client: "Racing Life"
sector: "Web design · Media platform"
year: "2026"
...
logo: "/work/racing-life/logo.svg"
logoColor: "#082040"
logoScale: 0.66
...
scope:
  ...
  - "Design system"
  - "Architecture"
  - "Three-app monorepo (Next.js + Express + CMS)"
  - "AI editorial pipeline with stop-slop scoring"
  - "Live odds + content"
outcome_kpis:
  - "Live since 2025 at racinglife.com.au"
  - "Three-app monorepo with live odds and editorial in one product"
  - "AI editorial pipeline that scales without shipping slop"
  - "The daily destination for the modern Australian racing fan"
quote:
  text: "The product's better than what we asked for, and we asked for a lot."
  author: "Racing Life founding team"
  role: "Editorial"
gallery:
...
Racing Life launched in 2025 to fill that gap. A racing media platform where expert previews and live odds sit alongside the lifestyle and culture that turn race day into more than a bet.
