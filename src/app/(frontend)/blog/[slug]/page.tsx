...
import { titleWithBrand, clampDescription, fitTitle } from '@/lib/seo-meta';
...
export async function generateMetadata({
  ...
  // Clamp whatever we end up with, CMS override included: a stored title or
  // description that runs past the search-result limit just truncates.
  const title = fitTitle(meta?.title ?? titleWithBrand(post.title));
  const description = clampDescription(meta?.description ?? post.excerpt);
